...
SpriteContainer::SpriteContainer() {
    std::string path = "tilemaps/Tiles/";
    ...
    _GIDsprites.emplace(Tiles::flower1        , Sprite::create(path + "blumen1_spring_summmer.png"));
    _GIDsprites.emplace(Tiles::flower2        , Sprite::create(path + "blumen2_spring_summmer.png"));
    _GIDsprites.emplace(Tiles::flower3        , Sprite::create(path + "blumen3_spring_summmer.png"));
    _GIDsprites.emplace(Tiles::flower4        , Sprite::create(path + "blumen4_spring_summmer.png"));
    _GIDsprites.emplace(Tiles::bush1          , Sprite::create(path + "busch1_spring_summmer.png"));
    _GIDsprites.emplace(Tiles::bush2          , Sprite::create(path + "busch2_spring_summmer.png"));
    _GIDsprites.emplace(Tiles::bush3          , Sprite::create(path + "busch3_spring_summmer.png"));
    _GIDsprites.emplace(Tiles::bush4          , Sprite::create(path + "busch4_spring_summmer.png"));
